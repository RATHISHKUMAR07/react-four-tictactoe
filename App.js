          ...
          {winMessage ? (
            <div className="mb-2 mt-2">
              ...
              <Button
                color="success"
                block
                onClick={reloadGame}//Not given parenthesis because it will call immediately
                //So we not given it will call after clicking button
              >Reload the Game</Button>
            </div>//mb-margin bottom mt-top
          ) : (
